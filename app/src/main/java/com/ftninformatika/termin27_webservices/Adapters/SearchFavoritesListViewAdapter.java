package com.ftninformatika.termin27_webservices.Adapters;
...
public class SearchFavoritesListViewAdapter extends BaseAdapter {

    private List<Movie> movies = null;
    private Activity activity;

    public SearchFavoritesListViewAdapter(Activity activity, List<Movie> movies) {
        this.movies = movies;
